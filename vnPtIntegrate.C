...
void LoadHEPData() {
	TFile *fflow = TFile::Open("data/HEPData-ins1666817-v1-5TeVPbPb_flow.root");  //https://doi.org/10.17182/hepdata.83737
	TFile *fspectra = TFile::Open("data/HEPData-ins1657384-v1-5TeVPbPb_spectra.root"); //https://doi.org/10.17182/hepdata.86210
	TH1F *hy1,*hy1_e1,*hy1_e2;
    for(int ic=0;ic<NC;ic++) {
	   gr_dndpt[ic] = (TGraphAsymmErrors*)fspectra->Get(Form("Table 2/Graph1D_y%d",ic+1));
       hy1 = (TH1F*)fspectra->Get(Form("Table 2/Hist1D_y%d",ic+1));
       hy1_e1 = (TH1F*)fspectra->Get(Form("Table 2/Hist1D_y%d_e1",ic+1));
       hy1_e2 = (TH1F*)fspectra->Get(Form("Table 2/Hist1D_y%d_e2",ic+1));
